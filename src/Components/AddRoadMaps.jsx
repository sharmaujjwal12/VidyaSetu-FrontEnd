  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-gray-100 flex items-center justify-center p-6">
      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-xl p-6 border border-gray-200">
        ...
        {/**Error Mesaage / Success */}
             {messagefromBackend.message ? (<div className="mb-5 flex items-center gap-3 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg shadow-sm animate-pulse">
            <svg
        ...
        onSubmit={onSubmitClicked} className="flex flex-col gap-4">
          ...
          {/* Button */}
          <button className="mt-3 w-full py-2 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 transition duration-300 shadow-md hover:shadow-lg" type="submit">
            + Add Roadmap
          </button>
        </form>
      </div>
